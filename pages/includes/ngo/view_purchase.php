...
//              }
    ...
    <div class="new-section">
      <div class="sidebar-container pull-left">
          ...
          <h2 class="text-center side-option" style="color:#777;font-size:30px;"><a href="add_product.php" style="color:#777;font-size:30px; text-decoration:none;">View Products</a></h2>
          <hr style="width:100%;background:#000000;">
  ...
  <tbody>
   <?php
      $query = "SELECT purchase.purchase_id, purchase.user_id, purchase.product_id, product.product_name, product.product_quantity, product.made_at, users.UNAME, users.U_EMAIL FROM purchase, product, users WHERE purchase.product_id = product.product_id AND purchase.user_id = users.UID";
      $result = mysqli_query($connection, $query);
