...
//              }
    ...
    <div class="new-section">
      <div class="sidebar-container pull-left">
          ...
          <h2 class="text-center side-option" style="color:#777;font-size:30px;"><a href="add-event.php" style="color:#777;font-size:30px; text-decoration:none;">Add Event</a></h2>
          <hr style="width:100%;background:#000000;">
          
          <h2 class="text-center side-option" style="color:#777;font-size:30px;"><a href="" style="color:#777;font-size:30px; text-decoration:none;">View all transactions</a></h2>
          <hr style="width:100%;background:#000000;">
  ...
  <div class="carousel-inner">
    ...
    <div class="item active">
      <img src="../../../img/tree.jpg" style="height: 500px; width: 1000px;" alt="Los Angeles">
    </div>

   
    <div class="item">
      <img src="../../../img/rawpixel-587848-unsplash.jpg" style="height: 500px; width: 1000px;" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="../../../img/flood.jpg" style="height: 500px; width: 1000px;" alt="Los Angeles">
    </div>
  </div>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
         ...
         <div class="container" style="background-color:white; margin-left: -100px">
<!--            <h3 style="margin-left: -100px; margin-top: 80px;">Contact Us :</h3>-->
            <br>
            <h4 style="margin-left: 400px; margin-top: 10px;"><?php echo $ngo_address; ?></h4>
            <h4 style="margin-left: 500px; margin-top: 10px;"><?php echo "Email: ".$ngo_email; ?></h4>
            
            <h4 style="margin-left: 520px; "><?php echo "Contact: ".$ngo_contact; ?></h4>
