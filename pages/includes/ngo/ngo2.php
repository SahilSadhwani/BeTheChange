...
//              }
    ...
    <div class="new-section">
      <div class="sidebar-container pull-left">
          ...
          <h2 class="text-center side-option" style="color:#777;font-size:30px;"><a href="view_all_requests.php" style="color:#777;font-size:30px; text-decoration:none;">Requests</a></h2>
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
      <img src="../../../img/donate.png" style="height: 500px; width: 1000px;" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="../../../img/Give-India.jpg" style="height: 500px; width: 1000px;" alt="Los Angeles">
    </div>
  </div>
