...
$query = "SELECT ngo.ngo_id, ngo.ngo_name, ngo.ngo_email, ngo.ngo_contact, ngo.ngo_address, ngo.ngo_category_id, ngo_details.ngo_description FROM ngo, ngo_details WHERE ngo.ngo_id = $ngo_id AND ngo.ngo_id = ngo_details.ngo_id";
...
//              }
    ...
    <div class="new-section">
      <div class="sidebar-container pull-left">
          ...
          <h2 class="text-center side-option" style="color:#777;font-size:30px;"><a href="" style="color:#777;font-size:30px; text-decoration:none;">View Purchases</a></h2>
          <hr style="width:100%;">
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
      <img src="../../../img/category/2.jpg" style="height: 500px; width: 1000px;" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="../../../img/category/4.jpg" style="height: 500px; width: 1000px;" alt="Los Angeles">
    </div>
  </div>
