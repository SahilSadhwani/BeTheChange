  ...
  <body style="background-color: #eee">
    ...
    <div class="new-section">
      <div class="sidebar-container pull-left">
          ...
          <h2 class="text-center side-option" style="color:#777;font-size:30px;">Add Product</h2>
          <hr style="width:100%;background:#000000;">
          
          <h2 class="text-center side-option" style="color:#777;font-size:30px;">View Purchases</h2>
          <hr style="width:100%;background:#000000;">
          
          <h2 class="text-center side-option" style="color:#777;font-size:30px;">View Products</h2>
          <hr style="width:100%;background:#000000;">
      ...
      <div class="right-container pull-left">
        ...
        <div class="add-event-form">
            <div class="card-container" style="height:750px;">
           <h1>ADD PRODUCT</h1>
           <hr class="rule">
            <form method="POST"  action="add_product_process.php" enctype="multipart/form-data"  >
                
                Product Name <input type="text" class="form-control" id="product_name" name="product_name"><br>
                Product Details <br><textarea name="product_details" id="" cols="80" rows="3"></textarea> 
                <br>
                <br>
                Product Category  <input type="text" class="form-control" id="amount" name="product_category"><br>
                Product Cost <input type="text" class="form-control" id="amount" name="product_cost"><br>
                                Product Quantity <input type="text" class="form-control" id="amount" name="product_quantity"><br>
...
<!--                            <span class="fileinput-new btn" style="color:black;border-radius:0px;border:1px solid black;" > Select image </span>-->
                ...
                <br>
                <button class="btn" type="submit" style="background:#fda401;border-radius:0px;color:white;float:left;" name="add_product">Add Product</button>
